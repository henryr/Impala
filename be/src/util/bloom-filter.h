...
class BloomFilter {
 public:
  ...
  explicit BloomFilter(const rpc::BloomFilterPB& proto);
  ~BloomFilter();
  ...
  /// elements.
  static void ToProto(const BloomFilter* filter, rpc::BloomFilterPB* proto);
  ...
  static void Or(const rpc::BloomFilterPB& in, rpc::BloomFilterPB* out);
 ...
 private:
  ...
  void ToProto(rpc::BloomFilterPB* proto) const;
