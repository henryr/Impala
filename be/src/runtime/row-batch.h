...
/// Container for a serialized row batch. All associated memory is shared by this structure
/// and, during TransmitData() transmission, the RPC layer which is why the buffers are
/// wrapped in shared_ptrs.
///
/// OutboundProtoRowBatch structs are reused for many RPCs. They contain buffers
/// for both compressed and uncompressed tuple data. These buffers are reused
struct OutboundProtoRowBatch {
 public:
  ...
  /// Compressed version of tuple_data. If compression is effective,
