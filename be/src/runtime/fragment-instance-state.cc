...
DEFINE_int32(rpc_report_exec_status_timeout_ms, 10000,
    "Timeout for fragment status reporting RPC");
...
void FragmentInstanceState::ReportStatusCb(
  ...
  rpc.SetTimeout(MonoDelta::FromMilliseconds(FLAGS_rpc_report_exec_status_timeout_ms));
