...
class DataStreamSender::Channel :
 ...
 public:
  ...
  Status SendSerializedBatch(const shared_ptr<OutboundProtoRowBatch>& batch) WARN_UNUSED_RESULT;
  ...
  Status WaitForClearChannel() WARN_UNUSED_RESULT;
  ...
  Status FlushAndSendEos() WARN_UNUSED_RESULT;
