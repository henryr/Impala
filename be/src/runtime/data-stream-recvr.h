...
class DataStreamRecvr {
 ...
 private:
  ...
  RuntimeProfile::Counter* good_bytes_received_counter_;
  ...
  /// Time spent in GetBatch() enqueuing responses to pending senders.
  RuntimeProfile::Counter* pending_response_timer_;
};
