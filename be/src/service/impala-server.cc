...
Status ImpalaServer::Init(int32_t service_port, int32_t beeswax_port, int32_t hs2_port) {
  ...
  if (service_port > 0) {
    ...
    unique_ptr<ServiceIf> ctrl_svc(new ImpalaInternalServiceImpl(mgr));
    RETURN_IF_ERROR(
